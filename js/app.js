...
function multiply(a, b) { //eslint-disable-line
  let product = a *b;
  let productStr = `The product of ${a} and ${b} is ${product}.`;
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  let productStr = `The product of ${a} and ${b} and ${c} is ${product}.`;
  
  return [mySum, product, sumStr, productStr];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  productStr = 'The numbers ' + dynamicArray.join() + ` have a product of ${product}.`;
